...
const FloatingLabelInput = ({
  ...
  return (
    <div className="relative group mb-4">
      ...
      {/* Floating Label - Dynamic Positioning */}
      <label
        htmlFor={id}
...
export function AuthPage({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      let name = "Water Warrior"; 
      let email = "";

      // Capture data based on active tab
      if (activeTab === 'signup') {
          ...
          <div className="mb-6 px-8">
            <div className="relative flex w-full rounded-full bg-white p-1 shadow-inner border border-gray-100">
              ...
              <button
                ...
                className={`relative z-10 flex-1 py-3 text-sm font-semibold transition-colors duration-200 ${
                  activeTab === 'login' ? 'text-white' : 'text-gray-500 hover:text-orange-500'
                }`}
              >
                Login
              </button>
              ...
              <button
                ...
                className={`relative z-10 flex-1 py-3 text-sm font-semibold transition-colors duration-200 ${
                  activeTab === 'signup' ? 'text-white' : 'text-gray-500 hover:text-orange-500'
                }`}
              >
                Sign Up
              </button>
          ...
          <div className="px-8 pb-10 min-h-[400px]">
            <AnimatePresence mode="wait">
              {activeTab === 'login' ? (
                ...
                >
                  <FloatingLabelInput id="email" label="Email or Phone" icon={Mail} required />
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-3 text-orange-900/40 hover:text-orange-600 transition-colors z-20"
                  ...
                  <div className="mt-6 text-center">
                    ...
                    <div className="flex justify-center gap-4">
                      ...
                      {/* Google Button */}
                      <button type="button" className="w-14 h-14 rounded-2xl bg-white border border-orange-100 flex items-center justify-center shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 group">
                      ...
                      {/* Apple Button */}
                      <button type="button" className="w-14 h-14 rounded-2xl bg-white border border-orange-100 flex items-center justify-center text-black shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 group">
                ...
                <motion.form
                  ...
                  onSubmit={handleSubmit}
                >
                  <FloatingLabelInput id="name" label="Full Name" icon={User} required />
                  <FloatingLabelInput id="signup-email" label="Email Address" icon={Mail} type="email" required />
                  <FloatingLabelInput id="signup-password" label="Create Password" icon={Lock} type="password" required />
                  <FloatingLabelInput id="confirm-password" label="Confirm Password" icon={CheckCircle} type="password" required />
